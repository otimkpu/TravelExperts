...
namespace TravelExperts
{
    public partial class FrmAddModifyDelete : Form
    {
        ...
        public suppliers modifyproductsupplier;
        ...
        {
            txtProductID.Text = modifyproductsupplier.ProductId.ToString();
            txtSupplierID.Text = modifyproductsupplier.SupplierId.ToString();           
        }
